...
2. When finished with all of the TODO items in codex-todo.md, **always** append a section to codex-todo.md that lists the files touched and a summary (including line number range) of the changes to the file. Do NOT write the summary in the conversation output - it must be appended to codex-todo.md itself
