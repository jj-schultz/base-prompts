...
if [ ! -f ./.ai_coding/claude/todo.md ]; then
  echo -e "# TODO List - **you must** first read and execute all the rules and steps defined in \`./.ai_coding/common/high_level_instructions.md\`, **ignore all files in \`./.ai_coding/codex**\`, then proceed to the following todo items:\n\n" > ./.ai_coding/claude/todo.md
fi

# Create todo.md in codex if it doesn't exist
if [ ! -f ./.ai_coding/codex/todo.md ]; then
  echo -e "# TODO List - **you must** first read and execute all the rules and steps defined in \`./.ai_coding/common/high_level_instructions.md\`, **ignore all files in \`./.ai_coding/claude**\`, then proceed to the following todo items:\n\n" > ./.ai_coding/codex/todo.md
fi
...
ln -s ~/src/base-prompts/ai_coding/common ./.ai_coding/common
