...
6. All rules defined in [instructions--coding_principles.md](instructions--coding_principles.md)
...
0. **IMPORTANT** If a line of text in the todo file starts with the character `$`, this signals that it might be a keyword command.  If you encounter a line that starts with $, inspect the file [instructions--keywords.md](instructions--keywords.md) for required guidance on how to proceed
...
5. Prepend to the top of the file `.ai_coding/history.md` a single line summary describing the the keyword reqested (if avail) and what you did and the suggested next step (code review, run tests, commit, etc) with short justification
```markdown
# <TIMESTAMP in YYYY-MM-DD HH:MM:SS format>
<single line summary describing the the keyword reqested (if avail) and what you did in the format>
